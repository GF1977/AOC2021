...
namespace MyApp
{
    ...
    public class Program
    {
        ...
        private static List<Room> InitRooms()
        {
            ...
            Rooms[9].isOccupiedBy = "D";
            Rooms[13].isOccupiedBy = "A";

            Rooms[10].isOccupiedBy = "D";
            Rooms[14].isOccupiedBy = "B";

            Rooms[11].isOccupiedBy = "A";
            Rooms[15].isOccupiedBy = "C";
        ...
        {
            if (S.ImHome == true || S.Id == LastMovedShrimp) return false;
